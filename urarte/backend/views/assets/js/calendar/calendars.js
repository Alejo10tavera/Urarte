...
(function() {
    ...
    calendar.bgColor = '#f9923d';
    calendar.dragBgColor = '#f9923d';
    calendar.borderColor = '#f9923d';
    ...
    calendar.color = '#ffffff';
    calendar.bgColor = '#4a4c70';
    calendar.dragBgColor = '#4a4c70';
    calendar.borderColor = '#4a4c70';
    addCalendar(calendar);
